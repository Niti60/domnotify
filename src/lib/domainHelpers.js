...
export function serializeDomain(domain) {
  ...
  return {
    ...
    expiry: formatDate(obj.expiryDate),
    expires: formatDate(obj.expiryDate),
    ...
    sslValidFrom: obj.sslValidFrom ? formatDate(obj.sslValidFrom) : '—',
    sslValidTo: obj.sslValidTo ? formatDate(obj.sslValidTo) : '—',
    sslStatus,
    sslDaysLeft: getDaysLeft(obj.sslValidTo),
    sslSerialNumber: obj.sslSerialNumber || '—',
    sslEncryption: obj.sslEncryption || '—',
    sslChainStatus: obj.sslChainStatus || '—',
